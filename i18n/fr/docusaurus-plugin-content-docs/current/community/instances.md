...
title: Instances gérées par la communauté
---
...
:::important
Tout autre serveur répertorié sur cette page, à l'exception de ceux ci-dessus, n'a aucune affiliation avec le projet Jitsi ou 8x8, Inc.
:::

### Misc. info & other server lists

Vous pouvez utiliser [DNS Lookup](https://www.ultratools.com/tools/dnsLookupResult), [GeoIP Lookup](https://www.ultratools.com/tools/geoIpResult) et [KeyCDN Geo Tool](https://tools.keycdn.com/geo) pour en savoir plus sur l'emplacement de chaque serveur.

* 📃 Liste des serveurs, fichier texte : [2021-12-26, 195 servers](https://gitlab.com/flavoursofopenscience/grav/-/raw/master/pages/02.community-run-open-source-tools-for-video-and-text-collaboration/20211226-jitsi-list-195-servers.txt)
...
* ➡️ [JitsiMonitor](https://guardianproject.gitlab.io/jitsi-monitor/) -- ([GitLab repo](https://gitlab.com/guardianproject/jitsi-monitor)) ... surveille les instances pour les temps de ping et la qualité TLS.
* ➡️ [JitsiMeter](https://ladatano.partidopirata.com.ar/jitsimeter/) -- ([JitsiMeter repo](https://0xacab.org/faras/jitsimeter)) ... une liste dynamique d'instances Jitsi Meet publiques triées en fonction des temps de ping et de la qualité TLS par rapport à l'emplacement d'un utilisateur.
* ➡️ [Jitsi Random Redirect](https://jitsi.random-redirect.de) -- ([GitHub repo](https://github.com/tosterkamp/random-redirect)) ... transfert automatique vers un jitsi-Server aléatoire


### Jitsi Meet apps

En plus de son interface client Web native, Jitsi Meet est également disponible en tant que
...
## Instances jit.si gérées par les utilisateurs et/ou la communauté par région

✅ = cette configuration jitsi n'utilise pas les serveurs STUN/TURN de Google

❌ = hébergé sur des serveurs Amazon, Google, Cloudflare ou Microsoft
